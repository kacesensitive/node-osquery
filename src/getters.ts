...
export async function getAtomPackages(): Promise<AtomPackage[]> {
    const output = await runOsquery('SELECT * FROM atom_packages', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
 ...
 */
export async function getAzureInstanceMetadata(): Promise<AzureInstanceMetadata[]> {
    const output = await runOsquery('SELECT * FROM azure_instance_metadata', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getCarbonBlackInfo(): Promise<CarbonBlackInfo[]> {
    const output = await runOsquery('SELECT * FROM carbon_black_info', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getCarves(): Promise<Carve[]> {
    const output = await runOsquery('SELECT * FROM carves', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getCertificates(): Promise<Certificate[]> {
    const output = await runOsquery('SELECT * FROM certificates', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
 ...
 */
export async function getChromeExtensionContentScripts(): Promise<ChromeExtensionContentScript[]> {
    const output = await runOsquery('SELECT * FROM chrome_extension_content_scripts', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
    const chromeExtensionContentScripts: ChromeExtensionContentScript[] = JSON.parse(output);
...
export async function getChromeExtensions(): Promise<ChromeExtension[]> {
    const output = await runOsquery('SELECT * FROM chrome_extensions', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getCpuInfo(): Promise<CPUInfo[]> {
    const output = await runOsquery('SELECT * FROM cpu_info', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getCpuid(): Promise<CPUID[]> {
    const output = await runOsquery('SELECT * FROM cpuid', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getCurl(): Promise<Curl[]> {
    const output = await runOsquery('SELECT * FROM curl', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getCurlCertificate(): Promise<CurlCertificate[]> {
    const output = await runOsquery('SELECT * FROM curl_certificate', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getEc2InstanceMetadata(): Promise<Ec2InstanceMetadata[]> {
    const output = await runOsquery('SELECT * FROM ec2_instance_metadata', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getEc2InstanceTags(): Promise<Ec2InstanceTags[]> {
    const output = await runOsquery('SELECT * FROM ec2_instance_tags', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getEtcHosts(): Promise<EtcHosts[]> {
    const output = await runOsquery('SELECT * FROM etc_hosts', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getEtcServices(): Promise<EtcServices[]> {
    const output = await runOsquery('SELECT * FROM etc_services', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getFile(): Promise<File[]> {
    const output = await runOsquery('SELECT * FROM file', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getGroups(): Promise<Group[]> {
    const output = await runOsquery('SELECT * FROM groups', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getHash(): Promise<Hash[]> {
    const output = await runOsquery('SELECT * FROM hash', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getInterfaceAddresses(): Promise<InterfaceAddresses[]> {
    const output = await runOsquery('SELECT * FROM interface_addresses', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getInterfaceDetails(): Promise<InterfaceDetails[]> {
    const output = await runOsquery('SELECT * FROM interface_details', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getKernelInfo(): Promise<KernelInfo> {
    const output = await runOsquery('SELECT * FROM kernel_info', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getListeningPorts(): Promise<ListeningPorts[]> {
    const output = await runOsquery('SELECT * FROM listening_ports', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getLoggedInUsers(): Promise<LoggedInUsers[]> {
    const output = await runOsquery('SELECT * FROM logged_in_users', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getMemoryDevices(): Promise<MemoryDevices[]> {
    const output = await runOsquery('SELECT * FROM memory_devices', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getNpmPackages(): Promise<NpmPackages[]> {
    const output = await runOsquery('SELECT * FROM npm_packages', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getOsVersion(): Promise<OsVersion> {
    const output = await runOsquery('SELECT * FROM os_version', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getOsqueryEvents(): Promise<OsqueryEvents[]> {
    const output = await runOsquery('SELECT * FROM osquery_events', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getOsqueryExtensions(): Promise<OsqueryExtensions[]> {
    const output = await runOsquery('SELECT * FROM osquery_extensions', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getOsqueryFlags(): Promise<OsqueryFlags[]> {
    const output = await runOsquery('SELECT * FROM osquery_flags', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getOsqueryInfo(): Promise<OsqueryInfo> {
    const output = await runOsquery('SELECT * FROM osquery_info', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getOsqueryPacks(): Promise<OsqueryPacks[]> {
    const output = await runOsquery('SELECT * FROM osquery_packs', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getOsqueryRegistry(): Promise<OsqueryRegistry[]> {
    const output = await runOsquery('SELECT * FROM osquery_registry', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getOsquerySchedule(): Promise<OsquerySchedule[]> {
    const output = await runOsquery('SELECT * FROM osquery_schedule', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getPlatformInfo(): Promise<PlatformInfo[]> {
    const output = await runOsquery('SELECT * FROM platform_info', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getProcessMemoryMap(): Promise<ProcessMemoryMap[]> {
    const output = await runOsquery('SELECT * FROM process_memory_map', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getProcessOpenSockets(): Promise<ProcessOpenSockets[]> {
    const output = await runOsquery('SELECT * FROM process_open_sockets', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getProcesses(): Promise<Processes[]> {
    const output = await runOsquery('SELECT * FROM processes', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getPythonPackages(): Promise<PythonPackages[]> {
    const output = await runOsquery('SELECT * FROM python_packages', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getSecureBoot(): Promise<SecureBoot[]> {
    const output = await runOsquery('SELECT * FROM secureboot', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getSshConfigs(): Promise<SshConfigs[]> {
    const output = await runOsquery('SELECT * FROM ssh_configs', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getStartupItems(): Promise<StartupItems[]> {
    const output = await runOsquery('SELECT * FROM startup_items', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getSystemInfo(): Promise<SystemInfo> {
    const output = await runOsquery('SELECT * FROM system_info', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getTime(): Promise<Time> {
    const output = await runOsquery('SELECT * FROM time', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getUptime(): Promise<Uptime> {
    const output = await runOsquery('SELECT * FROM uptime', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getUserGroups(): Promise<UserGroups[]> {
    const output = await runOsquery('SELECT * FROM user_groups', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getUserSshKeys(): Promise<UserSshKeys[]> {
    const output = await runOsquery('SELECT * FROM user_ssh_keys', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getUsers(): Promise<Users[]> {
    const output = await runOsquery('SELECT * FROM users', [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getYaraResults(path: string): Promise<Yara[]> {
    const output = await runOsquery(`SELECT * FROM yara WHERE path='${path}'`, [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getYaraEventResults(): Promise<YaraEvents[]> {
    const output = await runOsquery(`SELECT * FROM yara_events`, [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
 ...
 */
export async function getYCloudInstanceMetadata(): Promise<YCloudInstanceMetadata[]> {
    const output = await runOsquery(`SELECT * FROM ycloud_instance_metadata`, [OsType.LINUX, OsType.DARWIN, OsType.WINDOWS_NT]);
...
export async function getAppCompatShims(): Promise<AppCompatShims[]> {
    const output = await runOsquery(`SELECT * FROM appcompat_shims`, [OsType.WINDOWS_NT]);
...
export async function getAuthenticode(path: string): Promise<Authenticode[]> {
    const output = await runOsquery(`SELECT * FROM authenticode WHERE path='${path}'`, [OsType.WINDOWS_NT]);
...
export async function getAutoexec(): Promise<Autoexec[]> {
    const output = await runOsquery(`SELECT * FROM autoexec`, [OsType.WINDOWS_NT]);
 ...
 */
export async function getBackgroundActivitiesModerator(): Promise<BackgroundActivitiesModerator[]> {
    const output = await runOsquery(`SELECT * FROM background_activities_moderator`, [OsType.WINDOWS_NT]);
    const backgroundActivitiesModerator: BackgroundActivitiesModerator[] = JSON.parse(output);
...
export async function getBitlockerInfo(): Promise<BitlockerInfo[]> {
    const output = await runOsquery(`SELECT * FROM bitlocker_info`, [OsType.WINDOWS_NT]);
...
export async function getChassisInfo(): Promise<ChassisInfo[]> {
    const output = await runOsquery(`SELECT * FROM chassis_info`, [OsType.WINDOWS_NT]);
...
export async function getChocolateyPackages(): Promise<ChocolateyPackages[]> {
    const output = await runOsquery(`SELECT * FROM chocolatey_packages`, [OsType.WINDOWS_NT]);
...
export async function getConnectivity(): Promise<Connectivity> {
    const output = await runOsquery(`SELECT * FROM connectivity`, [OsType.WINDOWS_NT]);
...
export async function getDefaultEnvironment(): Promise<DefaultEnvironment[]> {
    const output = await runOsquery(`SELECT * FROM default_environment`, [OsType.WINDOWS_NT]);
...
export async function getDiskInfo(): Promise<DiskInfo[]> {
    const output = await runOsquery(`SELECT * FROM disk_info`, [OsType.WINDOWS_NT]);
...
export async function getDnsCache(): Promise<DnsCache[]> {
    const output = await runOsquery(`SELECT * FROM dns_cache`, [OsType.WINDOWS_NT]);
...
export async function getHvciStatus(): Promise<HvciStatus[]> {
    const output = await runOsquery(`SELECT * FROM hvci_status`, [OsType.WINDOWS_NT]);
...
export async function getIeExtensions(): Promise<IeExtensions[]> {
    const output = await runOsquery(`SELECT * FROM ie_extensions`, [OsType.WINDOWS_NT]);
...
export async function getKvaSpeculativeInfo(): Promise<KvaSpeculativeInfo[]> {
    const output = await runOsquery(`SELECT * FROM kva_speculative_info`, [OsType.WINDOWS_NT]);
...
export async function getLogicalDrives(): Promise<LogicalDrives[]> {
    const output = await runOsquery(`SELECT * FROM logical_drives`, [OsType.WINDOWS_NT]);
...
export async function getLogonSessions(): Promise<LogonSessions[]> {
    const output = await runOsquery(`SELECT * FROM logon_sessions`, [OsType.WINDOWS_NT]);
...
export async function getNTDomains(): Promise<NTDomains[]> {
    const output = await runOsquery(`SELECT * FROM ntdomains`, [OsType.WINDOWS_NT]);
...
export async function getNTFSACLPermissions(): Promise<NTFSACLPermissions[]> {
    const output = await runOsquery(`SELECT * FROM ntfs_acl_permissions`, [OsType.WINDOWS_NT]);
...
export async function getNTFSJournalEvents(): Promise<NTFSJournalEvents[]> {
    const output = await runOsquery(`SELECT * FROM ntfs_journal_events`, [OsType.WINDOWS_NT]);
...
export async function getOfficeMRU(): Promise<OfficeMRU[]> {
    const output = await runOsquery(`SELECT * FROM office_mru`, [OsType.WINDOWS_NT]);
 ...
 */
export async function getPhysicalDiskPerformance(): Promise<PhysicalDiskPerformance[]> {
    const output = await runOsquery(`SELECT * FROM physical_disk_performance`, [OsType.WINDOWS_NT]);
...
export async function getPowershellEvents(): Promise<PowershellEvents[]> {
    const output = await runOsquery(`SELECT * FROM powershell_events`, [OsType.WINDOWS_NT]);
...
export async function getPrefetchFiles(): Promise<Prefetch[]> {
    const output = await runOsquery(`SELECT * FROM prefetch`, [OsType.WINDOWS_NT]);
...
export async function getProcessEtwEvents(): Promise<ProcessEtwEvents[]> {
    const output = await runOsquery(`SELECT * FROM process_etw_events`, [OsType.WINDOWS_NT]);
...
export async function getPrograms(): Promise<Programs[]> {
    const output = await runOsquery(`SELECT * FROM programs`, [OsType.WINDOWS_NT]);
...
export async function getRegistry(): Promise<Registry[]> {
    const output = await runOsquery(`SELECT * FROM registry`, [OsType.WINDOWS_NT]);
...
export async function getScheduledTasks(): Promise<ScheduledTask[]> {
    const output = await runOsquery(`SELECT * FROM scheduled_tasks`, [OsType.WINDOWS_NT]);
...
export async function getSecurityProfileInfo(): Promise<SecurityProfileInfo[]> {
    const output = await runOsquery(`SELECT * FROM security_profile_info`, [OsType.WINDOWS_NT]);
...
export async function getServices(): Promise<Services[]> {
    const output = await runOsquery(`SELECT * FROM services`, [OsType.WINDOWS_NT]);
...
export async function getSharedResources(): Promise<SharedResources[]> {
    const output = await runOsquery(`SELECT * FROM shared_resources`, [OsType.WINDOWS_NT]);
...
export async function getShellbags(): Promise<Shellbags[]> {
    const output = await runOsquery(`SELECT * FROM shellbags`, [OsType.WINDOWS_NT]);
...
export async function getShimcache(): Promise<Shimcache[]> {
    const output = await runOsquery(`SELECT * FROM shimcache`, [OsType.WINDOWS_NT]);
...
export async function getTpmInfo(): Promise<TpmInfo[]> {
    const output = await runOsquery(`SELECT * FROM tpm_info`, [OsType.WINDOWS_NT]);
...
export async function getUserAssist(): Promise<UserAssist[]> {
    const output = await runOsquery(`SELECT * FROM userassist`, [OsType.WINDOWS_NT]);
...
export async function getVideoInfo(): Promise<VideoInfo[]> {
    const output = await runOsquery(`SELECT * FROM video_info`, [OsType.WINDOWS_NT]);
...
export async function getWinBaseObj(): Promise<WinBaseObj[]> {
    const output = await runOsquery(`SELECT * FROM winbaseobj`, [OsType.WINDOWS_NT]);
...
export async function getWindowsCrashes(): Promise<WindowsCrashes[]> {
    const output = await runOsquery(`SELECT * FROM windows_crashes`, [OsType.WINDOWS_NT]);
...
export async function getWindowsEventlog(): Promise<WindowsEventlog[]> {
    const output = await runOsquery(`SELECT * FROM windows_eventlog`, [OsType.WINDOWS_NT]);
...
export async function getWindowsEvents(): Promise<WindowsEvents[]> {
    const output = await runOsquery(`SELECT * FROM windows_events`, [OsType.WINDOWS_NT]);
 ...
 */
export async function getWindowsFirewallRules(): Promise<WindowsFirewallRules[]> {
    const output = await runOsquery(`SELECT * FROM windows_firewall_rules`, [OsType.WINDOWS_NT]);
 ...
 */
export async function getWindowsOptionalFeatures(): Promise<WindowsOptionalFeatures[]> {
    const output = await runOsquery(`SELECT * FROM windows_optional_features`, [OsType.WINDOWS_NT]);
 ...
 */
export async function getWindowsSecurityCenter(): Promise<WindowsSecurityCenter[]> {
    const output = await runOsquery(`SELECT * FROM windows_security_center`, [OsType.WINDOWS_NT]);
 ...
 */
export async function getWindowsSecurityProducts(): Promise<WindowsSecurityProducts[]> {
    const output = await runOsquery(`SELECT * FROM windows_security_products`, [OsType.WINDOWS_NT]);
 ...
 */
export async function getWindowsUpdateHistory(): Promise<WindowsUpdateHistory[]> {
    const output = await runOsquery(`SELECT * FROM windows_update_history`, [OsType.WINDOWS_NT]);
...
export async function getWmiBiosInfo(): Promise<WmiBiosInfo[]> {
    const output = await runOsquery(`SELECT * FROM wmi_bios_info`, [OsType.WINDOWS_NT]);
 ...
 */
export async function getWmiCliEventConsumers(): Promise<WmiCliEventConsumers[]> {
    const output = await runOsquery(`SELECT * FROM wmi_cli_event_consumers`, [OsType.WINDOWS_NT]);
...
export async function getWmiEventFilters(): Promise<WmiEventFilters[]> {
    const output = await runOsquery(`SELECT * FROM wmi_event_filters`, [OsType.WINDOWS_NT]);
 ...
 */
export async function getWmiFilterConsumerBinding(): Promise<WmiFilterConsumerBinding[]> {
    const output = await runOsquery(`SELECT * FROM wmi_filter_consumer_binding`, [OsType.WINDOWS_NT]);
    const wmiFilterConsumerBinding: WmiFilterConsumerBinding[] = JSON.parse(output);
 ...
 */
export async function getWmiScriptEventConsumers(): Promise<WmiScriptEventConsumers[]> {
    const output = await runOsquery(`SELECT * FROM wmi_script_event_consumers`, [OsType.WINDOWS_NT]);
...
export async function getIntelMeInfo(): Promise<IntelMeInfo[]> {
    const output = await runOsquery(`SELECT * FROM intel_me_info`, [OsType.LINUX, OsType.WINDOWS_NT]);
...
export async function getAcpiTables(): Promise<AcpiTables[]> {
    const output = await runOsquery(`SELECT * FROM acpi_tables`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getAugeas(): Promise<Augeas[]> {
    const output = await runOsquery(`SELECT * FROM augeas`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getAuthorizedKeys(): Promise<AuthorizedKeys[]> {
    const output = await runOsquery(`SELECT * FROM authorized_keys`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getBlockDevices(): Promise<BlockDevices[]> {
    const output = await runOsquery(`SELECT * FROM block_devices`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getCpuTime(): Promise<CpuTime[]> {
    const output = await runOsquery(`SELECT * FROM cpu_time`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getCrontab(): Promise<Crontab[]> {
    const output = await runOsquery(`SELECT * FROM crontab`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDeviceFile(): Promise<DeviceFile[]> {
    const output = await runOsquery(`SELECT * FROM device_file`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDeviceHash(): Promise<DeviceHash[]> {
    const output = await runOsquery(`SELECT * FROM device_hash`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDevicePartitions(): Promise<DevicePartitions[]> {
    const output = await runOsquery(`SELECT * FROM device_partitions`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDiskEncryption(): Promise<DiskEncryption[]> {
    const output = await runOsquery(`SELECT * FROM disk_encryption`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDnsResolvers(): Promise<DnsResolvers[]> {
    const output = await runOsquery(`SELECT * FROM dns_resolvers`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerContainerEnvs(): Promise<DockerContainerEnvs[]> {
    const output = await runOsquery(`SELECT * FROM docker_container_envs`, [OsType.LINUX, OsType.DARWIN]);
 ...
 */
export async function getDockerContainerFsChanges(): Promise<DockerContainerFsChanges[]> {
    const output = await runOsquery(`SELECT * FROM docker_container_fs_changes`, [OsType.LINUX, OsType.DARWIN]);
    const dockerContainerFsChanges: DockerContainerFsChanges[] = JSON.parse(output);
 ...
 */
export async function getDockerContainerLabels(): Promise<DockerContainerLabels[]> {
    const output = await runOsquery(`SELECT * FROM docker_container_labels`, [OsType.LINUX, OsType.DARWIN]);
 ...
 */
export async function getDockerContainerMounts(): Promise<DockerContainerMounts[]> {
    const output = await runOsquery(`SELECT * FROM docker_container_mounts`, [OsType.LINUX, OsType.DARWIN]);
 ...
 */
export async function getDockerContainerNetworks(): Promise<DockerContainerNetworks[]> {
    const output = await runOsquery(`SELECT * FROM docker_container_networks`, [OsType.LINUX, OsType.DARWIN]);
 ...
 */
export async function getDockerContainerPorts(): Promise<DockerContainerPorts[]> {
    const output = await runOsquery(`SELECT * FROM docker_container_ports`, [OsType.LINUX, OsType.DARWIN]);
 ...
 */
export async function getDockerContainerProcesses(): Promise<DockerContainerProcesses[]> {
    const output = await runOsquery(`SELECT * FROM docker_container_processes`, [OsType.LINUX, OsType.DARWIN]);
    const dockerContainerProcesses: DockerContainerProcesses[] = JSON.parse(output);
 ...
 */
export async function getDockerContainerStats(): Promise<DockerContainerStats[]> {
    const output = await runOsquery(`SELECT * FROM docker_container_stats`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerContainers(): Promise<DockerContainers[]> {
    const output = await runOsquery(`SELECT * FROM docker_containers`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerImageHistory(): Promise<DockerImageHistory[]> {
    const output = await runOsquery(`SELECT * FROM docker_image_history`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerImageLabels(): Promise<DockerImageLabels[]> {
    const output = await runOsquery(`SELECT * FROM docker_image_labels`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerImageLayers(): Promise<DockerImageLayers[]> {
    const output = await runOsquery(`SELECT * FROM docker_image_layers`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerImages(): Promise<DockerImages[]> {
    const output = await runOsquery(`SELECT * FROM docker_images`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerInfo(): Promise<DockerInfo> {
    const output = await runOsquery(`SELECT * FROM docker_info`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerNetworkLabels(): Promise<DockerNetworkLabels[]> {
    const output = await runOsquery(`SELECT * FROM docker_network_labels`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerNetworks(): Promise<DockerNetworks[]> {
    const output = await runOsquery(`SELECT * FROM docker_networks`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerVersion(): Promise<DockerVersion> {
    const output = await runOsquery(`SELECT * FROM docker_version LIMIT 1`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerVolumeLabels(): Promise<DockerVolumeLabels[]> {
    const output = await runOsquery(`SELECT * FROM docker_volume_labels`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getDockerVolumes(): Promise<DockerVolumes[]> {
    const output = await runOsquery(`SELECT * FROM docker_volumes`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getExtendedAttributes(): Promise<ExtendedAttributes[]> {
    const output = await runOsquery(`SELECT * FROM extended_attributes`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getFileEvents(): Promise<FileEvents[]> {
    const output = await runOsquery(`SELECT * FROM file_events`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getHardwareEvents(): Promise<HardwareEvents[]> {
    const output = await runOsquery(`SELECT * FROM hardware_events`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getInterfaceIpv6(): Promise<InterfaceIpv6[]> {
    const output = await runOsquery(`SELECT * FROM interface_ipv6`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getKnownHosts(): Promise<KnownHosts[]> {
    const output = await runOsquery(`SELECT * FROM known_hosts`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getLast(): Promise<Last[]> {
    const output = await runOsquery(`SELECT * FROM last`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getLoadAverage(): Promise<LoadAverage[]> {
    const output = await runOsquery(`SELECT * FROM load_average`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getMagic(): Promise<Magic[]> {
    const output = await runOsquery(`SELECT * FROM magic`, [OsType.LINUX, OsType.DARWIN]);
 ...
 */
export async function getMemoryArrayMappedAddresses(): Promise<MemoryArrayMappedAddresses[]> {
    const output = await runOsquery(`SELECT * FROM memory_array_mapped_addresses`, [OsType.LINUX, OsType.DARWIN]);
    const memoryArrayMappedAddresses: MemoryArrayMappedAddresses[] = JSON.parse(output);
...
export async function getMemoryArrays(): Promise<MemoryArrays[]> {
    const output = await runOsquery(`SELECT * FROM memory_arrays`, [OsType.LINUX, OsType.DARWIN]);
...
*/
export async function getMemoryDeviceMappedAddresses(): Promise<MemoryDeviceMappedAddresses[]> {
    const output = await runOsquery(`SELECT * FROM memory_device_mapped_addresses`, [OsType.LINUX, OsType.DARWIN]);
    const memoryDeviceMappedAddresses: MemoryDeviceMappedAddresses[] = JSON.parse(output);
...
export async function getMemoryErrorInfo(): Promise<MemoryErrorInfo[]> {
    const output = await runOsquery(`SELECT * FROM memory_error_info`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getMounts(): Promise<Mounts[]> {
    const output = await runOsquery(`SELECT * FROM mounts`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getOemStrings(): Promise<OemStrings[]> {
    const output = await runOsquery(`SELECT * FROM oem_strings`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getPciDevices(): Promise<PciDevices[]> {
    const output = await runOsquery(`SELECT * FROM pci_devices`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getProcessEnvs(): Promise<ProcessEnvs[]> {
    const output = await runOsquery(`SELECT * FROM process_envs`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getProcessEvents(): Promise<ProcessEvents[]> {
    const output = await runOsquery(`SELECT * FROM process_events`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getProcessOpenFiles(): Promise<ProcessOpenFiles[]> {
    const output = await runOsquery(`SELECT * FROM process_open_files`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getPrometheusMetrics(): Promise<PrometheusMetrics[]> {
    const output = await runOsquery(`SELECT * FROM prometheus_metrics`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getShellHistory(): Promise<ShellHistory[]> {
    const output = await runOsquery(`SELECT * FROM shell_history`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getSmbiosTables(): Promise<SmbiosTables[]> {
    const output = await runOsquery(`SELECT * FROM smbios_tables`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getSocketEvents(): Promise<SocketEvents[]> {
    const output = await runOsquery(`SELECT * FROM socket_events`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getSudoers(): Promise<Sudoers[]> {
    const output = await runOsquery(`SELECT * FROM sudoers`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getSuidBin(): Promise<SuidBin[]> {
    const output = await runOsquery(`SELECT * FROM suid_bin`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getSystemControls(): Promise<SystemControls[]> {
    const output = await runOsquery(`SELECT * FROM system_controls`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getUlimitInfo(): Promise<UlimitInfo[]> {
    const output = await runOsquery(`SELECT * FROM ulimit_info`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getUsbDevices(): Promise<UsbDevices[]> {
    const output = await runOsquery(`SELECT * FROM usb_devices`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getUserEvents(): Promise<UserEvents[]> {
    const output = await runOsquery(`SELECT * FROM user_events`, [OsType.LINUX, OsType.DARWIN]);
...
export async function getApparmorEvents(): Promise<ApparmorEvents[]> {
    const output = await runOsquery(`SELECT * FROM apparmor_events`, [OsType.LINUX]);
...
export async function getApparmorProfiles(): Promise<ApparmorProfiles[]> {
    const output = await runOsquery(`SELECT * FROM apparmor_profiles`, [OsType.LINUX]);
...
export async function getBpfProcessEvents(): Promise<BpfProcessEvents[]> {
    const output = await runOsquery(`SELECT * FROM bpf_process_events`, [OsType.LINUX]);
...
export async function getBpfSocketEvents(): Promise<BpfSocketEvents[]> {
    const output = await runOsquery(`SELECT * FROM bpf_socket_events`, [OsType.LINUX]);
...
export async function getKernelModules(): Promise<KernelModules[]> {
    const output = await runOsquery(`SELECT * FROM kernel_modules`, [OsType.LINUX]);
...
export async function getLxdCertificates(): Promise<LxdCertificates[]> {
    const output = await runOsquery(`SELECT * FROM lxd_certificates`, [OsType.LINUX]);
...
export async function getLxdClusterMembers(): Promise<LxdClusterMembers[]> {
    const output = await runOsquery(`SELECT * FROM lxd_cluster_members`, [OsType.LINUX]);
...
export async function getLxdInstanceConfig(): Promise<LxdInstanceConfig[]> {
    const output = await runOsquery(`SELECT * FROM lxd_instance_config`, [OsType.LINUX]);
...
export async function getLxdInstanceDevices(): Promise<LxdInstanceDevices[]> {
    const output = await runOsquery(`SELECT * FROM lxd_instance_devices`, [OsType.LINUX]);
...
export async function getLxdInstances(): Promise<LxdInstances[]> {
    const output = await runOsquery(`SELECT * FROM lxd_instances`, [OsType.LINUX]);
...
export async function getLxdStoragePools(): Promise<LxdStoragePools[]> {
    const output = await runOsquery(`SELECT * FROM lxd_storage_pools`, [OsType.LINUX]);
...
export async function getMdPersonalities(): Promise<MdPersonalities[]> {
    const output = await runOsquery(`SELECT * FROM md_personalities`, [OsType.LINUX]);
...
export async function getPortageKeywords(): Promise<PortageKeywords[]> {
    const output = await runOsquery(`SELECT * FROM portage_keywords`, [OsType.LINUX]);
...
export async function getPortagePackages(): Promise<PortagePackages[]> {
    const output = await runOsquery(`SELECT * FROM portage_packages`, [OsType.LINUX]);
...
export async function getProcessFileEvents(): Promise<ProcessFileEvents[]> {
    const output = await runOsquery(`SELECT * FROM process_file_events`, [OsType.LINUX]);
...
export async function getProcessNamespaces(): Promise<ProcessNamespaces[]> {
    const output = await runOsquery(`SELECT * FROM process_namespaces`, [OsType.LINUX]);
...
export async function getProcessOpenPipes(): Promise<ProcessOpenPipes[]> {
    const output = await runOsquery(`SELECT * FROM process_open_pipes`, [OsType.LINUX]);
...
export async function getRpmPackageFiles(): Promise<RpmPackageFiles[]> {
    const output = await runOsquery(`SELECT * FROM rpm_package_files`, [OsType.LINUX]);
...
export async function getSeccompEvents(): Promise<SeccompEvents[]> {
    const output = await runOsquery(`SELECT * FROM seccomp_events`, [OsType.LINUX]);
...
export async function getSelinuxEvents(): Promise<SelinuxEvents[]> {
    const output = await runOsquery(`SELECT * FROM selinux_events`, [OsType.LINUX]);
...
export async function getSelinuxSettings(): Promise<SelinuxSettings[]> {
    const output = await runOsquery(`SELECT * FROM selinux_settings`, [OsType.LINUX]);
...
export async function getSharedMemory(): Promise<SharedMemory[]> {
    const output = await runOsquery(`SELECT * FROM shared_memory`, [OsType.LINUX]);
...
export async function getSyslogEvents(): Promise<SyslogEvent[]> {
    const output = await runOsquery(`SELECT * FROM syslog_events`, [OsType.LINUX]);
...
export async function getSystemdUnits(): Promise<SystemdUnit[]> {
    const output = await runOsquery(`SELECT * FROM systemd_units`, [OsType.LINUX]);
...
export async function getAccountPolicyData(): Promise<AccountPolicyData[]> {
    const output = await runOsquery(`SELECT * FROM account_policy_data`, [OsType.DARWIN]);
...
export async function getAlfExceptions(): Promise<AlfExceptions[]> {
    const output = await runOsquery(`SELECT * FROM alf_exceptions`, [OsType.DARWIN]);
...
export async function getAlfExplicitAuths(): Promise<AlfExplicitAuths[]> {
    const output = await runOsquery(`SELECT * FROM alf_explicit_auths`, [OsType.DARWIN]);
...
*/
export async function getAuthorizationMechanisms(): Promise<AuthorizationMechanisms[]> {
    const output = await runOsquery(`SELECT * FROM authorization_mechanisms`, [OsType.DARWIN]);
...
export async function getAuthorizations(): Promise<Authorizations[]> {
    const output = await runOsquery(`SELECT * FROM authorizations`, [OsType.DARWIN]);
...
export async function getBrowserPluginInfo(): Promise<BrowserPlugins[]> {
    const output = await runOsquery(`SELECT * FROM browser_plugins`, [OsType.DARWIN]);
...
export async function getConfiguredPrinters(): Promise<CupsDestinations[]> {
    const output = await runOsquery(`SELECT * FROM cups_destinations`, [OsType.DARWIN]);
...
export async function getFirmwareVersions(): Promise<DeviceFirmware[]> {
    const output = await runOsquery(`SELECT * FROM device_firmware`, [OsType.DARWIN]);
...
export async function getEsProcessEvents(): Promise<EsProcessEvent[]> {
    const output = await runOsquery(`SELECT * FROM es_process_events`, [OsType.DARWIN]);
...
export async function getEsProcessFileEvents(): Promise<EsProcessFileEvent[]> {
    const output = await runOsquery(`SELECT * FROM es_process_file_events`, [OsType.DARWIN]);
...
export async function getFanSpeedSensors(): Promise<FanSpeedSensor[]> {
    const output = await runOsquery(`SELECT * FROM fan_speed_sensors`, [OsType.DARWIN]);
...
*/
export async function getGatekeeperApprovedApps(): Promise<GatekeeperApprovedApps[]> {
    const output = await runOsquery(`SELECT * FROM gatekeeper_approved_apps`, [OsType.DARWIN]);
...
export async function getHomebrewPackages(): Promise<HomebrewPackages[]> {
    const output = await runOsquery(`SELECT * FROM homebrew_packages`, [OsType.DARWIN]);
...
export async function getIBridgeInfo(): Promise<IBridgeInfo> {
    const output = await runOsquery(`SELECT * FROM ibridge_info`, [OsType.DARWIN]);
...
export async function getIOKitDeviceTree(): Promise<IOKitDeviceTree[]> {
    const output = await runOsquery(`SELECT * FROM iokit_devicetree`, [OsType.DARWIN]);
...
export async function getIOKitRegistry(): Promise<IOKitRegistry[]> {
    const output = await runOsquery(`SELECT * FROM iokit_registry`, [OsType.DARWIN]);
...
export async function getKernelExtensions(): Promise<KernelExtensions[]> {
    const output = await runOsquery(`SELECT * FROM kernel_extensions`, [OsType.DARWIN]);
...
export async function getKernelPanics(): Promise<KernelPanics[]> {
    const output = await runOsquery(`SELECT * FROM kernel_panics`, [OsType.DARWIN]);
...
export async function getKeychainAcls(): Promise<KeychainAcls[]> {
    const output = await runOsquery(`SELECT * FROM keychain_acls`, [OsType.DARWIN]);
...
export async function getKeychainItems(): Promise<KeychainItems[]> {
    const output = await runOsquery(`SELECT * FROM keychain_items`, [OsType.DARWIN]);
...
export async function getLaunchdOverrides(): Promise<LaunchdOverrides[]> {
    const output = await runOsquery(`SELECT * FROM launchd_overrides`, [OsType.DARWIN]);
...
export async function getLocationServices(): Promise<LocationServices> {
    const output = await runOsquery(`SELECT * FROM location_services`, [OsType.DARWIN]);
...
export async function getManagedPolicies(): Promise<ManagedPolicies[]> {
    const output = await runOsquery(`SELECT * FROM managed_policies`, [OsType.DARWIN]);
...
export async function getMdfindResults(query: string): Promise<Mdfind[]> {
    const output = await runOsquery(`SELECT * FROM mdfind WHERE query='${query}'`, [OsType.DARWIN]);
...
export async function getMdlsResults(path: string): Promise<Mdls[]> {
    const output = await runOsquery(`SELECT * FROM mdls WHERE path='${path}'`, [OsType.DARWIN]);
 ...
 * */
export async function getPackageInstallHistory(): Promise<PackageInstallHistory[]> {
    const output = await runOsquery(`SELECT * FROM package_install_history`, [OsType.DARWIN]);
...
export async function getPackageReceipts(): Promise<PackageReceipt[]> {
    const output = await runOsquery(`SELECT * FROM package_receipts`, [OsType.DARWIN]);
...
export async function getPasswordPolicies(): Promise<PasswordPolicy[]> {
    const output = await runOsquery(`SELECT * FROM password_policy`, [OsType.DARWIN]);
...
export async function getPlist(path: string): Promise<PlistEntry[]> {
    const output = await runOsquery(`SELECT * FROM plist WHERE path = '${path}'`, [OsType.DARWIN]);
...
export async function getPowerSensors(): Promise<PowerSensor[]> {
    const output = await runOsquery(`SELECT * FROM power_sensors`, [OsType.DARWIN]);
...
export async function getQuickLookCache(): Promise<QuickLookCache[]> {
    const output = await runOsquery(`SELECT * FROM quicklook_cache`, [OsType.DARWIN]);
...
export async function getRunningApps(): Promise<RunningApps[]> {
    const output = await runOsquery(`SELECT * FROM running_apps`, [OsType.DARWIN]);
...
export async function getSafariExtensions(): Promise<SafariExtensions[]> {
    const output = await runOsquery(`SELECT * FROM safari_extensions`, [OsType.DARWIN]);
...
export async function getSharedFolders(): Promise<SharedFolder[]> {
    const output = await runOsquery(`SELECT * FROM shared_folders`, [OsType.DARWIN]);
...
export async function getSharingPreferences(): Promise<SharingPreferences> {
    const output = await runOsquery(`SELECT * FROM sharing_preferences`, [OsType.DARWIN]);
...
export async function getSystemExtensions(): Promise<SystemExtensions[]> {
    const output = await runOsquery(`SELECT * FROM system_extensions`, [OsType.DARWIN]);
...
export async function getTemperatureSensors(): Promise<TemperatureSensor[]> {
    const output = await runOsquery(`SELECT * FROM temperature_sensors`, [OsType.DARWIN]);
...
export async function getTimeMachineBackups(): Promise<TimeMachineBackup[]> {
    const output = await runOsquery(`SELECT * FROM time_machine_backups`, [OsType.DARWIN]);
 ...
 */
export async function getTimeMachineDestinations(): Promise<TimeMachineDestinations[]> {
    const output = await runOsquery(`SELECT * FROM time_machine_destinations`, [OsType.DARWIN]);
 ...
 */
export async function getUserInteractionEvents(): Promise<UserInteractionEvents[]> {
    const output = await runOsquery(`SELECT * FROM user_interaction_events`, [OsType.DARWIN]);
...
export async function getVirtualMemoryInfo(): Promise<VirtualMemoryInfo> {
    const output = await runOsquery(`SELECT * FROM virtual_memory_info`, [OsType.DARWIN]);
...
export async function getWifiNetworks(): Promise<WifiNetworks[]> {
    const output = await runOsquery(`SELECT * FROM wifi_networks`, [OsType.DARWIN]);
...
export async function getXProtectEntries(): Promise<XProtectEntries[]> {
    const output = await runOsquery(`SELECT * FROM xprotect_entries`, [OsType.DARWIN]);
...
export async function getXProtectMeta(): Promise<XProtectMeta[]> {
    const output = await runOsquery(`SELECT * FROM xprotect_meta`, [OsType.DARWIN]);
...
export async function getXProtectReports(): Promise<XProtectReports[]> {
    const output = await runOsquery(`SELECT * FROM xprotect_reports`, [OsType.DARWIN]);
